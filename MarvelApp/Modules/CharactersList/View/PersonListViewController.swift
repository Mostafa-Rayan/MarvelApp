...
class PersonListViewController: UIViewController {
    ...
    private func setupTableView() {
        self.tableView.register(R.nib.personCell(), forCellReuseIdentifier: Constants.Cell.charactersList)
...
// MARK:- Extensions on PersonListViewController
...
extension PersonListViewController: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: Constants.Cell.charactersList) as! PersonCell
        let person = self.arrayPerson[indexPath.row]
